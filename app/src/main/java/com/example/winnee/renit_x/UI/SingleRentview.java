...
public class SingleRentview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_rentview);
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                mUserDatabase.child(Constants.USERS).child(dataSnapshot.child(Constants.USERUID).getValue().toString()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        {
                            Glide.with(SingleRentview.this)
                ...
                postimage1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent  = new Intent(SingleRentview.this,SinglePhotoView.class);
    ...
    private void firebase_data() {
        ...
        if (mAuth.getCurrentUser() == null)
        {
            ...
            Intent intent = new Intent(SingleRentview.this, Login.class);
